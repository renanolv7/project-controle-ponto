...
public class ControlePontoControllers {
    ...
    public ResponseEntity<ControlePontoEntity> baterPonto(@RequestBody PontoRequest request){
        ControlePontoEntity pontoSalvo = controlePontoService.registrarPonto(request.matricula, request.hora, request.data);
